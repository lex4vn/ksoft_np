						...
						<table class="form-table">
							...
							<tr valign="top">
								...
								<td class="sidebarBehavior">
									...
									<p class="description">
										Scrolling back up will immediately scroll the sidebar as well. Thus, the user can easily
									...
									<p class="description">
										Scrolling down will reveal the lower part of the sidebar only once you reach the page footer.
									...
									<p class="description">
										Scrolling back up will reveal the upper part of the sidebar only once you reach the page header.
							...
							<tr valign="top">
								...
								<td>
									...
									<p>
										<label>
											<input type="checkbox" value="true" class="disableOnResponsiveLayouts" checked>
											Disable on responsive layouts
										</label>
									</p>

									<p class="description">
										The plugin will be disabled if the container has a smaller or equal width than the sidebar.
									</p>
								</td>
							</tr>
						</table>
		...
		<script>
			(function ($) {
				...
				function renderSidebarRow(data) {
					...
					var tdNumber = $('<td>#' + (count + 1) + '</td>');

					var tdContent = $('#sidebarsTemplate').clone();

					var tdButtons = $('<td><button type="button" class="button button-remove"><span class="dashicons dashicons-trash"></span> Remove</button></td>');
