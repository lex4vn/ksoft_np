...
"use strict";
	...
	var aboveHeight = $('#head-main-top').outerHeight();
	    $(window).scroll(function(){
	    	if ($(window).scrollTop() > aboveHeight){
	    		$('#head-main-wrap').addClass('fixed').css('top','0');
	    		...
	    		$('#head-main-wrap').removeClass('fixed');
	...
	$('#nav-search-form-input, #page-mask').click(function () {
		searchActiveClass();
	});

	function searchActiveClass(){
		if(searchActive){
			$('body').removeClass('searching show-mask');
			$('body').removeClass('searching show-mask header-focus');
			$('#header').removeClass('header-focus');
			searchActive = false;
		}else{
			$('body').addClass('searching show-mask');
