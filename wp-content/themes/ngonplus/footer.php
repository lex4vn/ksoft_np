        ...
        <footer id="footer-unit">
            <div class="footer-nav-unit">
                <div class="dynamic-center-container clear">
                    <div class="dynamic-center">
                    <?php if (has_nav_menu( 'footer-nav')) {
                        wp_nav_menu(array( 'theme_location'=> 'footer-nav',
                        'items_wrap' => '<ul class="dynamic-center-inner clearfix">%3$s</ul>',
                        'depth' => -1 )); } ?>
                    </div>
                </div>

                <p class="footer-copyright">
                    © 2016 Thrillist Media Group, Inc, all rights reserved.
                </p>

                <div class="footer-logo-container">
                    <a target="_blank" href="http://www.thrillistmediagroup.com">
                        <figure class="footer-tmg-logo"></figure>
                    </a>
                </div>
            </div>
        </footer>
