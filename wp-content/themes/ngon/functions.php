...
add_filter( 'cherry_attr_content', 'cherry_attr_content_unit', 10 );
function cherry_attr_content_unit( $attr ) {
	$attr['id']    = 'content';
	$attr['class'] = apply_filters( 'cherry_get_content_class', 'clear' );
